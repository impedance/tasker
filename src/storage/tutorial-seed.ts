  ...
  return [
    {
      ...
      description: 'Your capital is p01. This is your base of operations. Learn to navigate the Strategic Map to reclaim the realm.',
      desiredOutcome: 'Understand the map interface',
      firstStep: 'Explore the map capital',
    ...
    },
    {
      ...
      description: 'The surrounding regions are shrouded in "Fog of War". You must clarify your intent before a province can be besieged.',
      state: 'fog',
      progressStage: 'scouted',
      decompositionCount: 0,
      mapSlotId: 'p02',
    ...
    },
    {
      ...
      description: 'Once a province is ready, you can start a Move. Consistent action is the key to victory.',
      desiredOutcome: 'Complete a small action',
      firstStep: 'Click on p03 and start a move',
